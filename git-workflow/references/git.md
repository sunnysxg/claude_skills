...
- 反过来也一样：**不把自己的未提交改动留在任何仓的主检出**，尤其是接了看板自动落位的仓——
  落位守卫见到主检出脏就停，你的半成品会挡住那个仓所有卡上线，而且没人会去那个仓看
  （CLAUDESKILLS-32 / 33 因一份跨仓顺手写下的文档改动空转两天）。要改别的仓，在那个仓开
  自己的 worktree，或直接在那个项目建卡交给下一个会话。
